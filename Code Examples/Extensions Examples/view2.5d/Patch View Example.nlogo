...
to go
  ...
  if drop != nobody [
    ...
    display
     ...
     ;; Update the view2.5d patch view
...
; procedure to open a view2.5 patch-view with the number of grains as the argument
to open-view2.5d
  ; open the patch view with a title
  view2.5d:patch-view "Sandpile 2.5D" [ [the-turtle] -> [ n ] of the-turtle ]
end

to set-view2.5d-perspective
  ; set the z-scale (how high the higest bar is)
  view2.5d:set-z-scale "Sandpile 2.5D" 5
  ; set the camera angle: heading and pitch
  view2.5d:set-observer-angles "Sandpile 2.5D" 200 35
end
