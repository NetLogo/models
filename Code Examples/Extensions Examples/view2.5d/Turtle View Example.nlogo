...
; procedure to open a 2.5D view to visualize infection-lengths for each turtle
to open-view2.5d-turtle-view
  view2.5d:turtle-view "AIDS 2.5D" turtles [ [the-turtle] -> [ infection-length ] of the-turtle ]
end

; procedure to set a good perspective for the 2.5D view
to set-view2.5d-perspective

  view2.5d:set-z-scale "AIDS 2.5D" 0.33
  view2.5d:set-observer-angles "AIDS 2.5D" 35 45
  view2.5d:set-observer-distance "AIDS 2.5D" 65
...
to go
  ...
  view2.5d:update-turtle-view "AIDS 2.5D" turtles
  tick
end
