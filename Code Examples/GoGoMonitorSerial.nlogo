...
to setup
  ...
  gogo-serial:talk-to-output-ports [ "a" "b" "c" "d"]
...
210
a-thisway
gogo-serial:talk-to-output-ports [ \"a\" ]\ngogo-serial:output-port-thisway
NIL
1
T
OBSERVER
...
251
a-thatway
gogo-serial:talk-to-output-ports [ \"a\" ]\ngogo-serial:output-port-thatway
NIL
1
T
OBSERVER
...
133
b-on
gogo-serial:talk-to-output-ports [ \"b\" ]\ngogo-serial:output-port-on
NIL
1
T
OBSERVER
...
368
set-b-power
gogo-serial:talk-to-output-ports [ \"b\" ]\ngogo-serial:set-output-port-power b-power
NIL
1
T
OBSERVER
...
133
c-on
gogo-serial:talk-to-output-ports [ \"c\" ]\ngogo-serial:output-port-on
NIL
1
T
OBSERVER
...
368
set-c-power
gogo-serial:talk-to-output-ports [ \"c\" ]\ngogo-serial:set-output-port-power c-power
NIL
1
T
OBSERVER
...
133
d-on
gogo-serial:talk-to-output-ports [ \"d\" ]\ngogo-serial:output-port-on
NIL
1
T
OBSERVER
...
368
set-d-power
gogo-serial:talk-to-output-ports [ \"d\" ]\ngogo-serial:set-output-port-power d-power
NIL
1
T
OBSERVER
...
This model communicates with the sensors and output ports of a [GoGo Board](http://gogoboard.org), an open source, easy-to-build, low cost, general purpose circuit board designed for educational projects. This model uses the old extension that connects to serial ports. For the new version, see the GoGo HID models.
