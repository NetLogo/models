...
This model communicates with the sensors and output ports of a [GoGo Board](http://gogoboardpi.org), an open source, easy-to-build, low cost, general purpose circuit board designed for educational projects.
