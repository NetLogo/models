...
;"baz!"</exitCondition>
  ...
  <experiment name="experiment2" repetitions="6" runMetricsEveryStep="true">
    <setup>setup-random</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>count patches with [living?]</metric>
...
;"baz!"</exitCondition>
  ...
  <experiment name="worldsize" repetitions="6" runMetricsEveryStep="true">
    <setup>setup-random</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>count patches with [living?]</metric>
  ...
  <experiment name="goBoom" repetitions="1" runMetricsEveryStep="true">
    <setup>setup-random</setup>
    <go>go
__ignore __boom</go>
  ...
  <experiment name="stopConditionGoBoom" repetitions="10" runMetricsEveryStep="true">
    <setup>setup-random</setup>
    <go>go</go>
    <exitCondition>__boom</exitCondition>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="initial-density">
      <value value="35"/>
    </enumeratedValueSet>
