...
to benchmark
  ...
  setup
  reset-timer
  ask-concurrent turtles [ repeat 350 [ go ] ]
  set result timer
end
...
to setup
  ...
  create-ordered-turtles number    ;;randomly distributes termites
  ask turtles [
    set color white
...
to find-empty-spot ; turtle procedure -- "puts down chip"
  ifelse pcolor = black
   [set pcolor yellow
    set color white
    get-away]
...
to wiggle ; turtle procedure
  fd 1
  set heading heading + random 50 - random 50
end
@#$#@#$#@
GRAPHICS-WINDOW
207
