...
This model extends the El Farol Extension 1 model by adding additional monitors to examine the distribution of rewards earned by the agents.
...
* Rand, W. and Wilensky, U. (2007).  NetLogo El Farol Extension 2 model.  http://ccl.northwestern.edu/netlogo/models/IABMTextbook/ElFarolExtension2.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
