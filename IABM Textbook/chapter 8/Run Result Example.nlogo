...
to setup
  ...
  crt 20 [
    pen-down
    set strategy ""
    repeat 5 [ set strategy (word strategy one-of inputs one-of operators) ]
    set strategy word strategy one-of inputs
  ]
  reset-ticks
end
...
The model initially creates 20 agents and a list of inputs, such as HEADING and XCOR, and operators, such as +, -, etc.  It then sets the strategy for each of the agents to a random set of five of input / command combinations.  When the model runs the agent simply executes their strategy.

## HOW TO USE IT

Press SETUP to create the agents and straegies.
