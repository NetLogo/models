...
255
410
When the connected Arduino is running the Code Example sketch, these buttons will turn the small user-LED on and off.
13
0.0
1
...
250
255
When the connected Arduino is running the Code Example sketch, these monitors will read numbers generated by the board.  (R will be a random number between 0 and 10, while C will count from 1 to 100 and then repeat).
13
0.0
1
