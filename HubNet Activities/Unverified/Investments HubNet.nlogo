...
* Wilensky, U. (2004).  NetLogo Investments HubNet model.  http://ccl.northwestern.edu/netlogo/models/HubNetInvestmentsHubNet.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
