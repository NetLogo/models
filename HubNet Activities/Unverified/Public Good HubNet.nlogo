...
* Wilensky, U. (2003).  NetLogo Public Good HubNet model.  http://ccl.northwestern.edu/netlogo/models/HubNetPublicGoodHubNet.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
