...
* Abrahamson, D. and Wilensky, U. (2004).  NetLogo Dice Stalagmite HubNet model.  http://ccl.northwestern.edu/netlogo/models/DiceStalagmiteHubNet.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
