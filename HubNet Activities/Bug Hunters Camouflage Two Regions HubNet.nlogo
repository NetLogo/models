...
* Novak, M. and Wilensky, U. (2006).  NetLogo HubNet Bug Hunters Camouflage Two Regions HubNet model.  http://ccl.northwestern.edu/netlogo/models/HubNetBugHuntersCamouflageTwoRegionsHubNet.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
