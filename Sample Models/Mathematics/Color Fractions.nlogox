...
<model version="NetLogo 7.0.2" snapToGrid="false">
  <code><![CDATA[patches-own [ column-number ]
...
; See Info tab for full copyright and license.]]></code>
  <widgets>
    <view x="333" wrappingAllowedX="false" y="10" frameRate="30.0" minPycor="-11" height="395" showTickCounter="false" patchSize="17.0" fontSize="13" wrappingAllowedY="false" width="327" tickCounterLabel="ticks" maxPycor="11" updateMode="1" maxPxcor="9" minPxcor="-9"></view>
    <slider x="9" step="1" y="173" max="100" width="313" display="numerator" height="50" min="0" direction="Horizontal" default="1.0" variable="numerator"></slider>
    <slider x="9" step="1" y="224" max="100" width="313" display="denominator" height="50" min="1" direction="Horizontal" default="7.0" variable="denominator"></slider>
    <button x="122" y="35" height="67" disableUntilTicks="true" forever="true" kind="Observer" width="110">go</button>
    <slider x="9" step="1" y="302" max="19" width="313" display="width" height="50" min="1" direction="Horizontal" default="19.0" variable="width"></slider>
    <button x="37" y="50" height="35" disableUntilTicks="false" forever="false" kind="Observer" width="66">setup</button>
    <note x="49" y="130" backgroundDark="0" fontSize="11" width="191" markdown="false" height="31" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">You can move the sliders while
the GO button is running.</note>
  </widgets>
