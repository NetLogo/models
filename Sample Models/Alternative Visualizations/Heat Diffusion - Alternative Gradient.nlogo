...
to color-patch  ;; Patch Procedure
 ...
 ;; calculate the index into the list of hsb colors
   ...
   ;; use 255/360 and 2.55 fudge factors to get around hsb primitive bug
  set pcolor __hsb-old ((255 / 360) * (first approximate-temp)) (2.55 * (item 1  approximate-temp)) (2.55 * (item 2 approximate-temp))
  ]
  ;; color patches using a gradient of rgb colors generated by the palette extension
  if color-scheme = "rgb" [
   ;; use polette extension to make a gradient of rgb colors
