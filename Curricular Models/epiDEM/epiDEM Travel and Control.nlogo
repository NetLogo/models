...
;; Those that live on the border are squares; those on the right, circles.
to setup-people
  crt initial-people
...
This model is an extension of the basic model of epiDEM (a curricular unit which stands for Epidemiology: Understanding Disease Dynamics and Emergence through Modeling). It simulates the spread of an infectious disease in a semi-closed population, but with additional features such as travel, isolation, quarantine, inoculation, and links between individuals. However, we still assume that the virus does not mutate, and that once an individual recovers, he or she is no longer susceptible to contracting the disease. To help visualize the effects of travel, two different populations, indicated by either a square or a circle, are initially divided by the yellow border which they can "travel" or cross over.

Overall, this model helps users:  
1) engage in a new way of viewing/modeling epidemics that is more personable and relatable,  
2) situate and understand the emergent disease spread dynamics in relation to the changes in various assumptions in prevention measures, travel, and mobility,  
3) understand how the reproduction number, R_0, represents the threshold for an epidemic,  
4) think about different ways to calculate R_0, and the strengths and weaknesses in each approach,  
5) understand the relationship between derivatives and integrals, represented simply as rates and cumulative number of cases, and  
6) provide opportunities to extend or change the model to include some properties of a disease that interest users the most.

## HOW IT WORKS

Individuals wander around the world in random motion. Upon coming into contact with an infected person, he or she has a chance of contracting the illness. Depending on their tendencies, which are set by the user, sick individuals will either isolate themselves at "home," go to a hospital, be force-quarantined into a hospital by health officials, or just move about. An infected individual has a chance of recovery after the given recovery time has elapsed.
...
- AVERAGE-ISOLATION-TENDENCY: Average tendency of individuals to want to isolate themselves and limit contact with others.  
- AVERAGE-HOSPITAL-GOING-TENDENCY: Average tendency of individuals to go to a hospital when sick.  
- INITIAL-AMBULANCE: the number of health officials or ambulances that force-quarantine sick individuals upon contact  
- INOCULATION-CHANCE: Probability of an individual getting vaccinated, and hence immune from the virus.  
- INTRA-MOBILITY: This indicates how "mobile" an individual is. Individuals move randomly by this assigned value; ambulances always move 5 times faster than this assigned value.
...
The slider INFECTION-CHANCE (10 - 50) determines the rate at which the disease spreads from one individual to another. When the INFECTION-RATE slider is set at zero, disease spread is unlikely, although (because the rates are assigned in a normal distribution) it is still possible.

The slider RECOVERY-CHANCE (10 - 100) determines how likely individuals are to recover, after the average recovery time has elapsed.

The slider AVERAGE-RECOVERY-TIME (50 - 300) determines the time required for each individual in the population to recover from the illness. This value indicates the time required, on average, for a person to recover. The actual individual's recovery time is pulled from a normal distribution centered around the AVERAGE-RECOVERY-TIME at its mean,  
with a standard deviation of a quarter of the AVERAGE-RECOVERY-TIME.

The sliders for AVERAGE-ISOLATION-TENDENCY (0 - 50) and AVERAGE-HOSPITAL-GOING-TENDENCY (0 - 50) are similar. Once an infected person is identified as an "isolator," the individual will isolate himself in the current location (as indicated by the grey patch) and will stay there until full recovery. During the isolation period the infected individual does not communicate the disease. If an infected person is identified as a "hospital goer," then he or she will go to the hospital, and will recover in half the time of an average recovery period, due to better medication and rest.

INITIAL-AMBULANCE (0 - 4)indicates the number of health officials in the world. These are the equivalent of Medecins sans frontieres, except perhaps even more mobile. They wander around the world in a random fashion, and upon encountering an infected person, will immediately transfer the individual to a hospital in the region in which the person was found. The health officials are immune to the disease, and they themselves do not physically accompany the patient to the hospital. They move at a speed 5 times as fast as other individuals in the world.

INOCULATION-CHANCE (0 - 50): This indicates the probability in which an individual will be inoculated from the virus. If an individual is inoculated, that is indicated by the color blue.

INTRA-MOBILITY (0 - 1): Usually, a person at each time step moves by a distance 1. In this model, the person will move at a distance indicated by the INTRA-MOBILITY at each tick. Thus, the lower the intra-mobility level, the less the movement in the individuals.

In addition, there are two choosers, and a related slider:
...
Compare with the simpler model. Do the added complexities significantly change the disease spread? What kinds of changes bring about interesting outcomes?
