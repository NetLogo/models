...
855
548
draw attract/repel force graph
draw-graph
T
1
T
...
175
123
re-setup particles only
ask particles [ random-position set heading random 360 set speed 6]
NIL
1
T
OBSERVER
...
900
506
Create graph to control attraction/\nrepulsion forces, (if switch is on)
13
14.0
1
